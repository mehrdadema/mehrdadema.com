...
Please click the following link to confirm the invite_002:
%4$s'
			);
...
if ( is_multisite() && current_user_can( 'promote_users' ) ) {
	...
	if ( ! current_user_can( 'manage_network_users' ) ) {
		echo '<p>' . __( 'Enter the email address of an existing user on this network to invite_002 them to this site. That person will be sent an email asking them to confirm the invite_002.' ) . '</p>';
		$label = __( 'Email' );
		$type  = 'email';
	} else {
		echo '<p>' . __( 'Enter the email address or username of an existing user on this network to invite_002 them to this site. That person will be sent an email asking them to confirm the invite_002.' ) . '</p>';
