...
class CubePortfolioBackend {
    ...
    public function register_assets() {
        ...
        // ADMIN
         ...
         wp_register_script( 'cubeportfolio-admin-js', CUBEPORTFOLIO_URL . 'admin/js/main.min-1.15.1.js', array('jquery', 'jquery-ui-draggable', 'jquery-ui-sortable'), CUBEPORTFOLIO_VERSION, true );
