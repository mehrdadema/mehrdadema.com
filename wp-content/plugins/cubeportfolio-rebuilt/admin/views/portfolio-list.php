...
<div class="wrap cbp-admin-wrap">
    ...
    <?php if ( isset( $_GET['deleted'] ) ) : ?>
        <div class="notice notice-success is-dismissible"><p>Portfolio deleted.</p></div>
    <?php endif; ?>
    <?php if ( isset( $_GET['cloned'] ) ) : ?>
        <div class="notice notice-success is-dismissible"><p>Portfolio cloned.</p></div>
    <?php endif; ?>

    <table class="wp-list-table widefat fixed striped cbp-portfolio-table">
        <thead>
            <tr>
        ...
        <?php if ( empty( $portfolios ) ) : ?>
            <tr><td colspan="5" style="text-align:center;padding:30px">No portfolios yet. <a href="<?php echo esc_url( admin_url( 'admin.php?page=cubeportfolio&action=new' ) ); ?>">Create your first one.</a></td></tr>
        <?php else : ?>
            ...
            <tr>
                ...
                <td>
                    <?php if ( $p->active ) : ?>
                        <span class="cbp-status-active">Active</span>
                    <?php else : ?>
                        <span class="cbp-status-inactive">Inactive</span>
                    <?php endif; ?>
                </td>
                <td class="cbp-actions">
                    ...
                    <a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=cubeportfolio&action=delete&id=' . $p->id ), 'cbp_delete_' . $p->id ) ); ?>" class="button button-small cbp-btn-delete" onclick="return confirm('Delete this portfolio? This cannot be undone.')">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        <?php endif; ?>
