<?php
/**
 * Template: Cube Portfolio – SinglePage popup template.
...
<div class="cbp-popup-singlePage cbpw-page-popup">
    <?php while ( have_posts() ) : the_post();
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="cbp-l-project-subtitle"><?php echo esc_html( $metadata['cbp_project_subtitle'][0] ?? '' ); ?></div>
            ...
            <div class="cbp-l-project-container">
                ...
                <?php if ( $has_content ) : ?>
                <div class="cbp-l-project-desc" <?php echo ! $has_details ? 'style="width:100%;"' : ''; ?>>
                    <div class="cbp-l-project-desc-title"><span><?php esc_html_e( 'Project Description', CBP_TEXTDOMAIN ); ?></span></div>
                    ...
                    $google    = ( ( $metadata['cbp_project_social_google'][0]    ?? '' ) === 'on' );
                    $pinterest = ( ( $metadata['cbp_project_social_pinterest'][0] ?? '' ) === 'on' );
                    ?>

                    <?php if ( $fb || $twitter || $google || $pinterest ) : ?>
                ...
                <?php if ( $has_details ) : ?>
                <div class="cbp-l-project-details" <?php echo ! $has_content ? 'style="width:100%;padding-left:0;"' : ''; ?>>
                    <div class="cbp-l-project-details-title"><span><?php esc_html_e( 'Project Details', CBP_TEXTDOMAIN ); ?></span></div>
                ...
                <?php if ( ! empty( $metadata['cbp_project_link'][0] ) ) : ?>
                    <a href="<?php echo esc_url( $metadata['cbp_project_link'][0] ); ?>"
                       ...
                       class="cbp-l-project-details-visit">
